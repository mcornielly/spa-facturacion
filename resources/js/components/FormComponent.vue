	...
	<div>
		<div class="panel" v-if="show">
			<div class="panel-heading">
				<span class="panel-title">{{ title }} Factura</span>
			</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="form-group">
							...
							<typeahead-component :url="customerURL" :initialize="form.customer"
								@input="onCustomer"/>
				...
				<table class="form-table">
					...
					<tbody>
						<tr v-for="(item, index) in form.items">
							<td class="w-14">
								<typeahead-component :url="productURL" :initialize="item.product"
					...
					<tfoot>
						<tr>
							<td colspan="2">
								<button class="btn btn-sm" @click="addProduct">Agregar Producto</button>
							</td>
							<td class="form-summary">Sub Total</td>
							<td>{{ subTotal | formatMoney }}</td>
						</tr>
						<tr>
							<td colspan="3" class="form-summary">Descuento</td>
							<td>
						...
						<tr>
							<td colspan="3" class="form-summary">Total Neto</td>
				...
				<div class="row">
					<div class="col-12">
						<div class="form-group">
							...
							<textarea class="form-control" name="" id="" cols="30" rows="10" v-model="form.terms_and_conditions"></textarea>
			...
			<div class="panel-footer flex-end">
				<div>
					<button class="btn btn-primary" :disabled="isProcessing" @click="onSave">Guardar</button>
					
					<button class="btn" :disabled="isProcessing" @click="onCancel">Cancelar</button>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	import { TypeaHead } from './partials/TypeaHead'
